# 🎨 Shadcn/UI NavigationMenu for Weweb

Beautiful **NavigationMenu component** from [shadcn/ui](https://ui.shadcn.com/) adapted for Weweb.

## 🚀 Import in Weweb

1. Copy this repository URL: `https://github.com/YOUR_USERNAME/shadcn-navigationmenu`
2. In Weweb editor, open developer panel (F12)
3. Add as "custom element"
4. The NavigationMenu component will appear in your elements!
...
├── src/
│   ├── NavigationMenu.vue    # Vue.js component
│   ├── cn.js            # CSS utility
